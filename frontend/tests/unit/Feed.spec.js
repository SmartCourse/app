...
describe('Feed.vue Reviews', () => {
  before(function() {
    this.items = [
      { id: 1, title: 'hey', body: 'wow', likes: 2, published: new Date() },
      { id: 2, title: 'blurggh', body: 'wowzers', likes: 3, published: new Date() }
    ]
...
describe('Feed.vue Questions', () => {
  before(function() {
    this.items = [
      { id: 1, title: 'hey', body: 'wow', likes: 2, published: new Date() },
      { id: 2, title: 'blurggh', body: 'wowzers', likes: 3, published: new Date() },
      { id: 3, title: 'blurggh', body: 'woawders', likes: 3, published: new Date() },
      { id: 4, title: 'blurggh', body: 'wdiajdw', likes: 3, published: new Date() }
    ]
    this.wrapper = mount(Feed, {
      propsData: {
