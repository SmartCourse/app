...
export const API_URL = process && process.env && process.env.NODE_ENV === "development"
  ? 'http://localhost:3000/api' : `https://smartcourse-${process.env.DEPLOY_TYPE}.azurewebsites.net/api`
