...
export const COMMITS = {
  ...
  [ACTIONS.DELETE_REVIEW]: '', // TODO (but maybe not)
  [ACTIONS.DELETE_REPLY]: '', // TODO properly (remove one reply, how to propagate id?)
  [ACTIONS.EDIT_REVIEW]: 'FOCUS_REVIEW',
  [ACTIONS.EDIT_REPLY]: '', // TODO properly (focus one reply)
